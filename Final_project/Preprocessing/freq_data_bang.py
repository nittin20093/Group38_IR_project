...
df1 = pd.read_csv('banglore_hotels_details_final.csv')
print(df1)

amenities = df1.iloc[:, -151:]
...
low_freq_amen=[]
keys = list(sorted_amen.keys())[110:122]
for i in keys:
...
df1.to_csv('banglore_hotels_details_final_freq.csv')
print(df1)

...
def similarity():
    if request.method == 'POST':
        ...
        if(u['city']=='Goa'):
            notpresentidx = [2,24,166,179,188,196,227,286,291,341,370,373,420,430,448,472,474,516]
            similar_images_index_list = filter_data.filter_with_similarity(notpresentidx,'goa/BasicRankedHotelsGoa.csv' , 'basic_ranked_datasets' , u['budget']['min'] , u['budget']['max'],  u['rating'] ,u['amenities'],u['selectedphotos'], u['selectedPhotos'],u['allphotos'],'goa_dataset')
        if(u['city']=='Bangalore'):
            notpresentidx = [5,14,25,27,44,45,50,55,68,69,77,90,95,102,104,105,106,107,117,118,119,120,138,142,148,154,169,180,186,194,267,291,372,387,458,514,538,542,549,552,556,562,565,567,577,581,596,605,607,642,651,662,671,688,696,699,703,710,713,716,718,721]
            similar_images_index_list = filter_data.filter_with_similarity(notpresentidx,'banglore/BasicRankedHotelsBangalore.csv' , 'basic_ranked_datasets' , u['budget']['min'] , u['budget']['max'],  u['rating'] ,u['amenities'],u['selectedphotos'], u['selectedPhotos'],u['allphotos'],'banglore_dataset')

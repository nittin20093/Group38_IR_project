...
df = pd.read_csv('./bangalore_hotel_links.csv')

urls = list(df['links'])
# urls = urls[631:]
all_urls = list(df['links'])

urls_idxs = [636, 637, 640, 656, 658, 659, 664, 666, 671, 672, 674, 676, 684, 686, 688, 692, 694, 695, 701, 702, 703, 704, 706, 715, 718, 724, 727, 728, 732, 734, 737, 738, 741, 742, 743, 747, 749, 752, 753, 754, 760, 761, 763, 765, 766, 768, 769, 773, 774, 775, 780, 783, 788, 791, 792, 797, 801, 803, 804, 810, 811, 812, 816, 821, 823, 827, 830, 833, 835, 836, 837, 840, 850, 855, 860, 861, 864, 868, 870, 875, 878, 880, 881, 885, 886, 888, 889, 890, 895, 897, 898, 900, 909, 917, 919, 924, 926, 927, 928, 929, 930, 932, 935, 939, 940, 946, 947, 948, 951, 953, 955, 956, 958, 961]

urls = list()

for eac in urls_idxs:
    urls.append(all_urls[eac])
...
for url in urls:
    ...
    df_details.to_csv('bangalore_hotel_details.csv')

        ...
        <div className='citypage'>
            ...
            <div className='hero'>
                ...
                <div className='sidebar2'>
                    ...
                    <Link to="/hotels/enjoy" state={{...propsdata, ...{indexes:selectedPhotos,selectedphotos:propsdata.selectedphotos.concat(selectedPhotos)}}}><button class="btn btn-success">SUBMIT</button></Link>

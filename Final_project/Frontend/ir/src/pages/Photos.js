        ...
        //     "data": {
            ...
            <div className='hero'>
                ...
                <div className='sidebar2'>
                    ...
                    <Link to="/hotels/hotels" state={{ ...propsdata, ...{selectedphotos:selectedPhotos, selectedPhotos:selectedPhotos, allphotos:photos_list}}}><button class="btn btn-success">SUBMIT</button></Link>
